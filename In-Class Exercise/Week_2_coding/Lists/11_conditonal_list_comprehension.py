...
def is_consonant(letter):
    vowels = 'aeiou'
    return letter.isalpha() and letter.lower() not in vowels  # isalpha() True: If all characters in the string are letters (A-Z, a-z, and Unicode letters from other languages)
